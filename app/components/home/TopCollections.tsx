      ...
      <div className="space-y-1">
        {collections.map((c) => (
          <Link
            ...
            className="flex items-center gap-3 py-2 px-1 hover:bg-[#1e1e1e] rounded-lg transition-colors"
          >
            <img src={c.imageUrl} alt={c.name} className="w-10 h-10 rounded-full flex-shrink-0" />
            ...
            <div className="text-right flex-shrink-0">
              ...
              <div className={`text-xs ${c.change1d >= 0 ? "text-green-400" : "text-red-400"}`}>
